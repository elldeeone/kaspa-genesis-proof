...
pub(crate) struct GoFixture {
    pub(crate) root: PathBuf,
    pub(crate) expected_db_path: PathBuf,
    pub(crate) tip_hash: Hash32,
}
...
fn hash32_from_hex(hex_str: &str) -> Hash32 {
    ...
    decoded.as_slice().try_into().expect("32-byte hash")
}
...
pub(crate) fn create_go_fixture(tempdir: &TempDir, stale_tip: bool) -> GoFixture {
