"""
Store module for Go-based kaspad nodes
This module provides database access for the original Go implementation of Kaspa.
For Rust-based rusty-kaspa nodes, use store_rust.py instead.
"""
