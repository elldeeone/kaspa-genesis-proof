...
pub(crate) struct VerificationReport {
    ...
    pub(crate) checkpoint_utxos_gz: Option<String>,
    ...
    pub(crate) checkpoint_utxo_dump_verified: bool,
    pub(crate) checkpoint_utxo_dump_source: Option<String>,
    pub(crate) checkpoint_utxo_dump_source_url: Option<String>,
    pub(crate) checkpoint_utxo_dump_records: Option<u64>,
    pub(crate) checkpoint_utxo_commitment: Option<String>,
    pub(crate) checkpoint_daa_score: Option<u64>,
    pub(crate) checkpoint_total_sompi: Option<String>,
    pub(crate) checkpoint_total_kas: Option<String>,
    pub(crate) checkpoint_reference_baseline_kas: Option<String>,
    pub(crate) checkpoint_excess_over_reference_kas: Option<String>,
